...
add_arg('init_from_pretrained_model',   str, './models/baidu_cn1.2k_model_fluid/params.pdparams',    "If None, the training starts from scratch, otherwise, it resumes from the pre-trained model.")
