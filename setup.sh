...
pip3 install numba==0.52.0 librosa==0.8.0 scipy==1.5.4 resampy==0.2.2 SoundFile==0.9.0.post1 python_speech_features==0.6 flask flask-cors paddlepaddle-gpu==1.8.5.post107 visualdl==2.1.1 -i https://mirrors.aliyun.com/pypi/simple/
if [ $? != 0 ]; then
