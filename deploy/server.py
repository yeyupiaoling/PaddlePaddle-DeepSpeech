...
# yapf: disable
add_arg('host_port',        int,    10086,    "Server's IP port.")
...
add_arg('speech_save_dir',  str,    './audios_cache',        "Directory to save demo audios.")
add_arg('warmup_manifest',  str,    './dataset/manifest.test',        "Filepath of manifest to warm up.")
